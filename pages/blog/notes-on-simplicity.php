<?php
/**
 * Blog Post: Notes on Simplicity
 */
$page_title = 'Notes on Simplicity — Sadab Munshi';
$page_description = 'Less is usually better. Some thoughts on keeping things simple.';
...
<div class="container page-content">
  <article class="content">
    ...
    <p style="color: var(--color-text-secondary); font-size: 0.875rem;">
      Simplicity is a journey, not a destination. What have you simplified lately? <a href="/contact/">Share your thoughts</a>.
    </p>
  </article>
</div>
