<?php
/**
 * Blog Post: Why I Started Making Things
 */
$page_title = 'Why I Started Making Things — Sadab Munshi';
$page_description = 'On curiosity, starting small, and creating for yourself.';
...
<div class="container page-content">
  <article class="content">
    ...
    <p style="color: var(--color-text-secondary); font-size: 0.875rem;">
      Thanks for reading. If this resonated with you, I'd love to hear about what you're building. <a href="/contact/">Get in touch</a>.
    </p>
  </article>
</div>
