<?php
/**
 * Blog Post: Slow Growth
 */
$page_title = 'Slow Growth — Sadab Munshi';
$page_description = 'Embracing the long, unglamorous path of gradual improvement.';
...
<div class="container page-content">
  <article class="content">
    ...
    <p style="color: var(--color-text-secondary); font-size: 0.875rem;">
      What are you slowly growing toward? I'd love to hear about your journey. <a href="/contact/">Share it with me</a>.
    </p>
  </article>
</div>
