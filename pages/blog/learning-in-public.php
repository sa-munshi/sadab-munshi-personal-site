<?php
/**
 * Blog Post: Learning in Public
 */
$page_title = 'Learning in Public — Sadab Munshi';
$page_description = 'The fear, the vulnerability, and the unexpected benefits of sharing while you learn.';
